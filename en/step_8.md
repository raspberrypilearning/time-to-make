...
![Cutting out two small spacer circles.](images/small-dials1.png){:width="500px"}
![Making a hole in the centre of a spacer circle.](images/small-dials2.png){:width="500px"}
...
![The spacer circles attached to the motor shaft.](images/small-dials3.png){:width="500px"}
...
![A video of attaching the wheel to the spacer circles.](images/attach.gif){:width="500px"}
![An animation showing the box without the wheel and the box once the wheel has been attached.](images/decor-2.gif){:width="500px"}
...
![The LED has been taped under the wheel, next to one of the text options.](images/LED-1.png){:width="500px"}
...
![A video of moving the wheel so that the window is lined up with a text option.](images/move.gif){:width="500px"}
...
![The wires and breadboard inside the box.](images/wires.png){:width="500px"}
